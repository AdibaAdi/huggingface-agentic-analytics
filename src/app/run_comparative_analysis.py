...
Runs the same set of natural language prompts through all four sandboxes
and writes a JSON report capturing latency, success, and notes for each
combination. The written report in ``doc/comparative_analysis_report.md``
consumes this JSON.
...
from app.code_generator import generate_python_code
from app.sandboxes import SANDBOXES
